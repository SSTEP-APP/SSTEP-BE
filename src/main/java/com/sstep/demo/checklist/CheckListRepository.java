...
public interface CheckListRepository extends JpaRepository<CheckList, Long> {
    ...
    @Query("SELECT cm.checkList FROM CheckListManager cm WHERE cm.staff.store.id = :storeId and cm.staff.id = :staffId and cm.checkList.isComplete = false")
    Set<CheckList> findCheckListsByStoreIdAndStaffIdAndIsUnCompleted(Long storeId, Long staffId);
}
